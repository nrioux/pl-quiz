...
(function($PS) {
  ...
  // Set the response, only if the question has not already been submitted
  ...
  // Modify the status for the question in the array at the given index
  ...
  // Get index of next unsubmitted question
      ...
      var render = function (v) {
          var qui = Data_Maybe.fromMaybe(Halogen_HTML_Core.text("Error."))(Control_Bind.bind(Data_Maybe.bindMaybe)(Data_Array.index(v.questions)(v.page))(function (question) {
              return Data_Maybe.Just.create(Halogen_HTML.slot()(new Data_Symbol.IsSymbol(function () {
                  ...
                  return Data_Maybe.Just.create(ResponseEvent.create($31));
              }));
          }));
          var nav = Halogen_HTML.slot()(new Data_Symbol.IsSymbol(function () {
              ...
              return Data_Maybe.Just.create(NavEvent.create($32));
          });
              ...
              return Control_Bind.bind(Halogen_Query_HalogenM.bindHalogenM)(Control_Monad_State_Class.get(Halogen_Query_HalogenM.monadStateHalogenM))(function (state) {
                  ...
                  if (newQuestions instanceof Data_Maybe.Just) {
                      return Control_Monad_State_Class.put(Halogen_Query_HalogenM.monadStateHalogenM)((function () {
                          ...
                          $25.questions = newQuestions.value0;
                          return $25;
                      })());
                  };
                  ...
                  throw new Error("Failed pattern match at Quiz (line 99, column 5 - line 101, column 27): " + [ newQuestions.constructor.name ]);
              });
          };
          throw new Error("Failed pattern match at Quiz (line 87, column 3 - line 87, column 98): " + [ v.constructor.name ]);
      };
...
(function($PS) {
  ...
  var component = (function () {
      ...
      var handleAction = function (v) {
          ...
          throw new Error("Failed pattern match at Main (line 65, column 3 - line 65, column 74): " + [ v.constructor.name ]);
      };
      return Halogen_Component.mkComponent({
          initialState: initialState,
          render: render,
