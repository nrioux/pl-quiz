      ...
      return function (resp) {
          return function (questions) {
              return Data_Array.modifyAt(page)(function (oldQuestion) {
                  var $12 = Common.submitted(oldQuestion);
                  if ($12) {
                      return oldQuestion;
                  };
                  return {
              ...
              return new Data_Maybe.Just((Data_FoldableWithIndex.foldlWithIndex(Data_FoldableWithIndex.foldableWithIndexArray)(function (i) {
                  return function (best) {
                      return function (q) {
                          ...
                          var $13 = Common.submitted(q) || relBestIdx <= relIdx;
                          if ($13) {
                              return best;
                          };
                          return {
      ...
      var render = function (v) {
          ...
          var qui = Data_Maybe.fromMaybe(Halogen_HTML_Core.text("Error."))(Control_Bind.bind(Data_Maybe.bindMaybe)(Data_Array.index(v.questions)(v.page))(function (question) {
              return Data_Maybe.Just.create(Halogen_HTML.slot()(new Data_Symbol.IsSymbol(function () {
                  ...
                  return Data_Maybe.Just.create(ResponseEvent.create($51));
              }));
          }));
          var nav = Halogen_HTML.slot()(new Data_Symbol.IsSymbol(function () {
              ...
              return Data_Maybe.Just.create(NavEvent.create($52));
          });
      ...
      var handleAction = function (v) {
          ...
          if (v instanceof ResponseEvent && v.value0 instanceof QuestionUI.Submit) {
              return Control_Bind.bind(Halogen_Query_HalogenM.bindHalogenM)(Control_Monad_State_Class.get(Halogen_Query_HalogenM.monadStateHalogenM))(function (v1) {
                  ...
                  return Control_Bind.discard(Control_Bind.discardUnit)(Halogen_Query_HalogenM.bindHalogenM)(Control_Monad_State_Class.put(Halogen_Query_HalogenM.monadStateHalogenM)(v2.newState))(function () {
                      if (v2.maybePoints instanceof Data_Maybe.Nothing) {
                          return Control_Applicative.pure(Halogen_Query_HalogenM.applicativeHalogenM)(Data_Unit.unit);
                      };
                      if (v2.maybePoints instanceof Data_Maybe.Just) {
                          return Control_Bind.bind(Halogen_Query_HalogenM.bindHalogenM)(Effect_Aff_Class.liftAff(Halogen_Query_HalogenM.monadAffHalogenM(dictMonadAff))(Affjax.post_("/score")(Data_Maybe.Just.create(Affjax_RequestBody.json(Data_Argonaut_Encode_Class.encodeJson(Data_Argonaut_Encode_Class.encodeRecord(Data_Argonaut_Encode_Class.gEncodeJsonCons(Data_Argonaut_Encode_Class.encodeJsonInt)(Data_Argonaut_Encode_Class.gEncodeJsonCons(Data_Argonaut_Encode_Class.encodeRecord(Data_Argonaut_Encode_Class.gEncodeJsonCons(Data_Argonaut_Encode_Class.encodeJsonInt)(Data_Argonaut_Encode_Class.gEncodeJsonCons(Data_Argonaut_Encode_Class.encodeJsonJString)(Data_Argonaut_Encode_Class.gEncodeJsonNil)(new Data_Symbol.IsSymbol(function () {
                              return "name";
                      ...
                      throw new Error("Failed pattern match at Quiz (line 107, column 5 - line 110, column 34): " + [ v2.maybePoints.constructor.name ]);
                  });
              });
          };
              ...
              return Control_Bind.bind(Halogen_Query_HalogenM.bindHalogenM)(Control_Monad_State_Class.get(Halogen_Query_HalogenM.monadStateHalogenM))(function (state) {
                  ...
                  if (newQuestions instanceof Data_Maybe.Just) {
                      return Control_Monad_State_Class.put(Halogen_Query_HalogenM.monadStateHalogenM)((function () {
                          ...
                          $40.questions = newQuestions.value0;
                          return $40;
                      })());
                  };
                  ...
                  throw new Error("Failed pattern match at Quiz (line 116, column 5 - line 118, column 27): " + [ newQuestions.constructor.name ]);
              });
          };
          if (v instanceof Receive) {
              return Control_Monad_State_Class.modify_(Halogen_Query_HalogenM.monadStateHalogenM)(function (state) {
                  ...
                  $46.scores = v.value0.scores;
                  return $46;
              });
          };
          throw new Error("Failed pattern match at Quiz (line 96, column 3 - line 96, column 98): " + [ v.constructor.name ]);
      };
      return Halogen_Component.mkComponent({
          initialState: initialState,
          render: render,
          "eval": Halogen_Component.mkEval({
              ...
              handleQuery: Halogen_Component.defaultEval.handleQuery,
              receive: function ($53) {
                  return Data_Maybe.Just.create(Receive.create($53));
              },
              initialize: Halogen_Component.defaultEval.initialize,
              finalize: Halogen_Component.defaultEval.finalize
          })
