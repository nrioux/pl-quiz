...
(function($PS) {
  ...
  var Unsubmitted = (function () {
      ...
      Unsubmitted.value = new Unsubmitted();
      return Unsubmitted;
  })();
...
(function($PS) {
  ...
  var PageChange = (function () {
      function PageChange(value0) {
          this.value0 = value0;
      };
      PageChange.create = function (value0) {
          return new PageChange(value0);
      };
      return PageChange;
  })();
  var Receive = (function () {
  ...
  var initialState = function (state) {
      return state;
  };
  var handleAction = function (v) {
      ...
      if (v instanceof NextPage) {
          return Control_Bind.bind(Halogen_Query_HalogenM.bindHalogenM)(Control_Monad_State_Class.get(Halogen_Query_HalogenM.monadStateHalogenM))(function (state) {
              var newPage = state.page + 1 | 0;
              return Halogen_Query_HalogenM.raise(new PageChange(newPage));
          });
      };
      ...
      if (v instanceof SetPage) {
          return Halogen_Query_HalogenM.raise(new PageChange(v.value0));
      };
      throw new Error("Failed pattern match at Nav (line 65, column 1 - line 65, column 49): " + [ v.constructor.name ]);
  };
  var btn = function (props) {
      return function (onClick) {
          return function (text) {
              return Halogen_HTML_Elements.button(Data_Semigroup.append(Data_Semigroup.semigroupArray)([ Halogen_HTML_Properties.classes([ "btn", "btn-light" ]), Halogen_HTML_Properties.type_(Halogen_HTML_Core.isPropButtonType)(DOM_HTML_Indexed_ButtonType.ButtonButton.value), Halogen_HTML_Events.onClick(onClick) ])(props))([ Halogen_HTML_Core.text(text) ]);
          };
      };
  };
  var render = function (state) {
      var qList = Data_Array.mapWithIndex(function (page) {
          return function (q) {
              ...
              var pts = (function () {
                  if (q.status instanceof Common.Unsubmitted) {
                      return "\u2013";
                  };
                  if (q.status instanceof Common.Submitted) {
                      return Data_Show.show(Data_Show.showInt)(q.status.value0.points);
                  };
                  throw new Error("Failed pattern match at Nav (line 46, column 42 - line 48, column 77): " + [ q.status.constructor.name ]);
              })();
              var badge = (function () {
                  if (q.status instanceof Common.Unsubmitted) {
                  ...
                  if (q.status instanceof Common.Submitted) {
                      if (q.status.value0.points <= 0) {
                          return "badge-danger";
                      };
                      if (q.status.value0.points >= q.sample.value) {
                  ...
                  throw new Error("Failed pattern match at Nav (line 49, column 44 - line 54, column 93): " + [ q.status.constructor.name ]);
              })();
              return Halogen_HTML_Elements.a([ Halogen_HTML_Properties.href("#"), Halogen_HTML_Properties.classes(Data_Semigroup.append(Data_Semigroup.semigroupArray)([ "list-group-item", "list-group-item-action" ])(itemClass)), Halogen_HTML_Events.onClick(function (v) {
                  return Data_Maybe.Just.create(new SetPage(page));
              }) ])([ Halogen_HTML_Core.text("Question " + Data_Show.show(Data_Show.showInt)(page + 1 | 0)), Halogen_HTML_Elements.span([ Halogen_HTML_Properties.classes([ "badge", badge, "float-right" ]) ])([ Halogen_HTML_Core.text(pts + (" / " + (Data_Show.show(Data_Show.showInt)(q.sample.value) + " pts"))) ]) ]);
          };
      })(state.questions);
      var pageProgress = Data_Show.show(Data_Show.showInt)(state.page + 1 | 0) + (" / " + Data_Show.show(Data_Show.showInt)(Data_Array.length(state.questions)));
      return Halogen_HTML_Elements.div_([ Halogen_HTML_Elements.div([ Halogen_HTML_Properties.class_("text-center") ])([ btn([ Halogen_HTML_Properties.disabled(state.page <= 0) ])(Data_Function["const"](new Data_Maybe.Just(PrevPage.value)))("\xab"), Halogen_HTML_Core.text(pageProgress), btn([ Halogen_HTML_Properties.disabled(state.page >= (Data_Array.length(state.questions) - 1 | 0)) ])(Data_Function["const"](new Data_Maybe.Just(NextPage.value)))("\xbb") ]), Halogen_HTML_Elements.div([ Halogen_HTML_Properties.class_("list-group") ])(qList) ]);
  };
  var navComp = Halogen_Component.mkComponent({
      ...
      "eval": Halogen_Component.mkEval({
          ...
          receive: function ($13) {
              return Data_Maybe.Just.create(Receive.create($13));
          },
...
(function($PS) {
  // Generated by purs version 0.13.8
  "use strict";
  $PS["QuestionUI"] = $PS["QuestionUI"] || {};
  var exports = $PS["QuestionUI"];
  var Common = $PS["Common"];
  var Control_Bind = $PS["Control.Bind"];
  var Control_Monad_State_Class = $PS["Control.Monad.State.Class"];
  var Data_Array = $PS["Data.Array"];
  ...
  var SetResponse = (function () {
      function SetResponse(value0) {
          this.value0 = value0;
      };
      SetResponse.create = function (value0) {
          return new SetResponse(value0);
      };
      return SetResponse;
  })();
  var Submit = (function () {
  ...
  var DoSubmit = (function () {
      ...
      DoSubmit.value = new DoSubmit();
      return DoSubmit;
  })();
  var SetAlgo = (function () {
      function SetAlgo(value0) {
          this.value0 = value0;
      };
      SetAlgo.create = function (value0) {
          return new SetAlgo(value0);
      };
      return SetAlgo;
  })();
  var SetLang = (function () {
      function SetLang(value0) {
          this.value0 = value0;
      };
      SetLang.create = function (value0) {
          return new SetLang(value0);
      };
      return SetLang;
  })();
  var render = function (state) {
      var langOpts = Data_Functor.map(Data_Functor.functorArray)(function (lang) {
          return Halogen_HTML_Elements.option([ Halogen_HTML_Properties.selected(state.question.response.language === lang) ])([ Halogen_HTML_Core.text(lang) ]);
      })(state.langs);
      var algoOpts = Data_Functor.map(Data_Functor.functorArray)(function (algo) {
          return Halogen_HTML_Elements.option([ Halogen_HTML_Properties.selected(state.question.response.algorithm === algo) ])([ Halogen_HTML_Core.text(algo) ]);
      })(state.algos);
      return Halogen_HTML_Elements.div_([ Halogen_HTML_Elements.h2_([ Halogen_HTML_Core.text("Question " + Data_Show.show(Data_Show.showInt)(state.page + 1 | 0)) ]), Halogen_HTML_Elements.pre([ Halogen_HTML_Properties.class_("pre-scrollable") ])([ Halogen_HTML_Core.text(state.question.sample.code) ]), Halogen_HTML_Elements.h2_([ Halogen_HTML_Core.text("Response") ]), Halogen_HTML_Elements.label_([ Halogen_HTML_Core.text("Algorithm "), Halogen_HTML_Elements.select([ Halogen_HTML_Events.onSelectedIndexChange(function (idx) {
          return Data_Functor.map(Data_Maybe.functorMaybe)(SetAlgo.create)(Data_Array.index(state.algos)(idx));
      }), Halogen_HTML_Properties.disabled(Common.submitted(state.question)) ])(algoOpts) ]), Halogen_HTML_Elements.br_, Halogen_HTML_Elements.label_([ Halogen_HTML_Core.text("Language "), Halogen_HTML_Elements.select([ Halogen_HTML_Events.onSelectedIndexChange(function (idx) {
          return Data_Functor.map(Data_Maybe.functorMaybe)(SetLang.create)(Data_Array.index(state.langs)(idx));
      }), Halogen_HTML_Properties.disabled(Common.submitted(state.question)) ])(langOpts) ]), Halogen_HTML_Elements.br_, Halogen_HTML_Elements.button([ Halogen_HTML_Properties.classes([ "btn", "btn-primary" ]), Halogen_HTML_Events.onClick(function (v) {
          return new Data_Maybe.Just(DoSubmit.value);
      }), Halogen_HTML_Properties.disabled(Common.submitted(state.question)) ])([ Halogen_HTML_Core.text("Submit Answer") ]) ]);
  };
  var initialState = function (state) {
      return state;
  };
  var handleAction = function (v) {
      ...
      if (v instanceof DoSubmit) {
          return Halogen_Query_HalogenM.raise(Submit.value);
      };
      if (v instanceof SetAlgo) {
          return Control_Bind.bind(Halogen_Query_HalogenM.bindHalogenM)(Control_Monad_State_Class.get(Halogen_Query_HalogenM.monadStateHalogenM))(function (state) {
              var resp = {
                  algorithm: v.value0,
                  language: state.question.response.language
              };
              return Halogen_Query_HalogenM.raise(new SetResponse(resp));
          });
      };
      if (v instanceof SetLang) {
          return Control_Bind.bind(Halogen_Query_HalogenM.bindHalogenM)(Control_Monad_State_Class.get(Halogen_Query_HalogenM.monadStateHalogenM))(function (state) {
              var resp = {
                  language: v.value0,
                  algorithm: state.question.response.algorithm
              };
              return Halogen_Query_HalogenM.raise(new SetResponse(resp));
          });
      };
      throw new Error("Failed pattern match at QuestionUI (line 51, column 1 - line 51, column 49): " + [ v.constructor.name ]);
  };
  var questionComp = Halogen_Component.mkComponent({
      initialState: initialState,
      render: render,
      "eval": Halogen_Component.mkEval({
          handleAction: handleAction,
  ...
  exports["questionComp"] = questionComp;
})(PS);
(function($PS) {
  // Generated by purs version 0.13.8
  "use strict";
  $PS["Samples"] = $PS["Samples"] || {};
  var exports = $PS["Samples"];
  var samples = [ {
      id: 5,
      value: 2,
      algorithm: "Levenshtein Distance",
      language: "Perl",
      code: "use List::Util 'min';\x0a\x0amy %cache;\x0a\x0asub f {\x0a        my ($s, $t) = @_;\x0a        return length($t) if !$s;\x0a        return length($s) if !$t;\x0a\x0a        $cache{\"$s,$t\"} //=          # try commenting out this line\x0a        do {\x0a                my ($s1, $t1) = (substr($s, 1), substr($t, 1));\x0a\x0a                (substr($s, 0, 1) eq substr($t, 0, 1))\x0a                        ? f($s1, $t1)\x0a                        : 1 + min(f($s1, $t1),\x0a                                  f($s,  $t1),\x0a                                  f($s1, $t ));\x0a        };\x0a} "
  }, {
      id: 7,
      value: 2,
      algorithm: "Pi Estimation",
      language: "Rust",
      code: "extern crate rand;\x0a\x0ause rand::Rng;\x0ause std::f64::consts::PI;\x0a\x0afn g((x, y): (f64, f64)) -> bool {\x0a    x * x + y * y <= 1.0\x0a}\x0a\x0afn f<R: Rng>(rng: &mut R, x: usize) -> f64 {\x0a    let mut count = 0;\x0a    for _ in 0..x {\x0a        if g(rng.gen()) {\x0a            count += 1;\x0a        }\x0a    }\x0a    4.0 * (count as f64) / (x as f64)\x0a}"
  }, {
      id: 0,
      value: 2,
      language: "Python",
      algorithm: "N queens",
      code: "def g(col, things):\x0a    return col in things or \\\x0a           any(abs(col - x) == len(things)-i for i,x in enumerate(things))\x0a\x0adef solve(n):\x0a    solutions = [[]]\x0a    for row in range(n):\x0a        solutions = [solution+[i+1]\x0a                       for i in range(SIZE)\x0a                       for solution in solutions\x0a                       if not g(i+1, solution)]\x0a    return solutions\x0a\x0afor answer in solve(SIZE): print(list(enumerate(answer, start=1)))"
  }, {
      id: 4,
      value: 2,
      algorithm: "Binary representation of int",
      language: "x86 Assembly",
      code: "\x09mov di, 15\x0a\x09mov bx, buf\x0a\x0aloop:\x0a\x09mov cx, '1'\x0a\x09shr ax, 1\x0a\x09jc skip\x0a\x09sub cx, 1\x0askip:\x0a\x09mov [bx+di], cl\x0a\x09dec di\x0a\x09jns loop "
  }, {
      id: 13,
      value: 2,
      algorithm: "Matrix transposition",
      language: "Ruby",
      code: "def f(m)\x0a  m[0].zip(*m[1..-1])\x0aend"
  }, {
      id: 10,
      value: 2,
      algorithm: "Linked list reversal",
      language: "C",
      code: "typedef struct e* l;\x0a\x0astruct e { int i; l n; };\x0a\x0al f(l x){\x0a    l t, y = x, r = NULL;\x0a    while(y != NULL){\x0a        t = y->n;\x0a        y->n = r;\x0a        r = y;\x0a        y = t;\x0a    }\x0a    return r;\x0a}"
  }, {
      id: 6,
      value: 2,
      algorithm: "Lempel-Ziv-Welch compression",
      language: "Haskell",
      code: "import Data.List\x0aimport Data.Maybe\x0a\x0adoF _ [] = []\x0adoF as (x:xs) =  f (map return as) [x] xs\x0a   where f a w [] = [fromJust $ elemIndex w a]\x0a         f a w (x:xs)  | w' `elem` a = f a w' xs\x0a                       | otherwise   = fromJust (elemIndex w a) : f (a++[w']) [x] xs\x0a              where w' = w++[x]"
  }, {
      id: 8,
      value: 2,
      algorithm: "Sieve of Eratosthenes",
      language: "WebAssembly",
      code: "(module\x0a (import \"js\" \"print\" (func $print (param i32)))\x0a (memory 4096)\x0a\x0a (func $f (export \"f\") (param $n i32)\x0a   (local $i i32)\x0a   (local $j i32)\x0a\x0a   (set_local $i (i32.const 0))\x0a   (block $endLoop\x0a     (loop $loop\x0a       (br_if $endLoop (i32.ge_s (get_local $i) (get_local $n)))\x0a       (i32.store8 (get_local $i) (i32.const 1))\x0a       (set_local $i (i32.add (get_local $i) (i32.const 1)))\x0a       (br $loop)))\x0a\x0a   (set_local $i (i32.const 2))\x0a   (block $endLoop\x0a     (loop $loop\x0a       (br_if $endLoop (i32.ge_s (i32.mul (get_local $i) (get_local $i))\x0a                                 (get_local $n)))\x0a       (if (i32.eq (i32.load8_s (get_local $i)) (i32.const 1))\x0a         (then\x0a           (set_local $j (i32.mul (get_local $i) (get_local $i)))\x0a           (block $endInnerLoop\x0a             (loop $innerLoop\x0a               (i32.store8 (get_local $j) (i32.const 0))\x0a               (set_local $j (i32.add (get_local $j) (get_local $i)))\x0a               (br_if $endInnerLoop (i32.ge_s (get_local $j) (get_local $n)))\x0a               (br $innerLoop)))))\x0a       (set_local $i (i32.add (get_local $i) (i32.const 1)))\x0a       (br $loop)))\x0a\x0a   (set_local $i (i32.const 2))\x0a   (block $endLoop\x0a     (loop $loop\x0a       (if (i32.eq (i32.load8_s (get_local $i)) (i32.const 1))\x0a         (then\x0a           (call $print (get_local $i))))\x0a       (set_local $i (i32.add (get_local $i) (i32.const 1)))\x0a       (br_if $endLoop (i32.ge_s (get_local $i) (get_local $n)))\x0a       (br $loop)))))"
  }, {
      id: 9,
      value: 2,
      algorithm: "Outputs own source code",
      language: "Prolog",
      code: "f :-\x0a\x09listing(f)."
  }, {
      id: 3,
      value: 2,
      algorithm: "Fractal tree drawing",
      language: "LOGO",
      code: " to f :depth :length :scale :angle\x0a  if :depth=0 [stop]\x0a  setpensize round :depth/2\x0a  forward :length\x0a  right :angle\x0a  f :depth-1 :length*:scale :scale :angle\x0a  left 2*:angle\x0a  f :depth-1 :length*:scale :scale :angle\x0a  right :angle\x0a  back :length\x0aend\x0a\x0aclearscreen\x0af 10 80 0.7 30\x0a"
  }, {
      id: 1,
      value: 2,
      language: "Coq",
      algorithm: "Ackermann function",
      code: "Section FOLD.\x0a  Context {A: Type} (f: A -> A) (a: A).\x0a  Fixpoint fold (n: nat) : A :=\x0a    match n with\x0a    | O => a\x0a    | S n' => f (fold n')\x0a    end.\x0aEnd FOLD.\x0a\x0aDefinition f : nat -> nat -> nat :=\x0a  fold (fun g => fold g (g (S O))) S. "
  }, {
      id: 11,
      value: 2,
      algorithm: "Square root",
      language: "TeX",
      code: "\\def\\f#1{{\\zzcnA=#1\x0a\\zzcnC=0\\zzcnD=1\x0a\\loop\\zzcnE=\\zzcnA\\divide\\zzcnE by \\zzcnD\\advance\\zzcnE by 1\x0a\\relax\\ifnum\\zzcnD<\\zzcnE\\relax\x0a\\advance \\zzcnC by 1\\multiply\\zzcnD by 2\x0a\\repeat\x0a\\zzcnB=0\x0a\\loop\\ifnum\\zzcnC>0\\relax\x0a\\advance\\zzcnC by -1\\divide\\zzcnD by 2\x0a\\zzcnE=\\zzcnB\\advance\\zzcnE by \\zzcnD\\multiply\\zzcnE by \\zzcnE\\relax\x0a\\ifnum\\zzcnA<\\zzcnE\\relax\\else\\advance\\zzcnB by \\zzcnD\\fi\x0a\\repeat\x0a\\global\\zzglobalcnA=\\zzcnB}}"
  }, {
      id: 12,
      value: 2,
      algorithm: "Subtraction of Church Numerals",
      language: "Lambda Calculus",
      code: "\\ n m.\x0a  m (\\ n.\x0a      n (\\ p f.\x0a          f (p (\\ a b. b))\x0a            (\\ f x. f (p (\\ a b. b) f x))\x0a\x09)\x0a        (\\ f. f (\\ f x. x) (\\ f x. x))\x0a\x09(\\ a b. a)\x0a    )\x0a    n"
  }, {
      id: 2,
      value: 2,
      algorithm: "Bubble sort",
      language: "JavaScript",
      code: "Array.prototype.f = function() {\x0a    var done = false;\x0a    while (!done) {\x0a        done = true;\x0a        for (var i = 1; i<this.length; i++) {\x0a            if (this[i-1] > this[i]) {\x0a                done = false;\x0a                [this[i-1], this[i]] = [this[i], this[i-1]]\x0a            }\x0a        }\x0a    }\x0a    return this;\x0a}"
  }, {
      id: 14,
      value: 2,
      algorithm: "Y combinator",
      language: "PostScript",
      code: "f {\x0a    {dup cons} exch concat dup cons i\x0a}."
  } ];
...
(function($PS) {
  ...
  var comp = (function () {
      var render = function (v) {
          var sortedScores = Data_List.sortBy(function (a) {
              return function (b) {
                  return Data_Ordering.invert(Data_Ord.compare(Data_Ord.ordInt)(a.score)(b.score));
              };
          })(v.scores);
          var renderRow = function (i) {
              return function (score) {
                  var rowClass = (function () {
                      var $4 = v.key === score.team.key;
                      if ($4) {
                          return "table-primary";
                      };
                      return "table-default";
                  })();
                  return Halogen_HTML_Elements.tr([ Halogen_HTML_Properties.classes([ rowClass ]) ])([ Halogen_HTML_Elements.td_([ Halogen_HTML_Core.text(Data_Show.show(Data_Show.showInt)(i + 1 | 0)) ]), Halogen_HTML_Elements.td_([ Halogen_HTML_Core.text(score.team.name) ]), Halogen_HTML_Elements.td_([ Halogen_HTML_Core.text(Data_Show.show(Data_Show.showInt)(score.score)) ]) ]);
              };
          };
          var rows = Data_Array.fromFoldable(Data_List_Types.foldableList)(Data_List.mapWithIndex(renderRow)(sortedScores));
          return Halogen_HTML_Elements.div([ Halogen_HTML_Properties.class_("mt-3") ])([ Halogen_HTML_Elements.h2_([ Halogen_HTML_Core.text("Leaderboard") ]), Halogen_HTML_Elements.table([ Halogen_HTML_Properties.classes([ "table", "table-striped" ]) ])(Data_Semigroup.append(Data_Semigroup.semigroupArray)([ Halogen_HTML_Elements.tr_([ Halogen_HTML_Elements.th_([ Halogen_HTML_Core.text("Rank") ]), Halogen_HTML_Elements.th_([ Halogen_HTML_Core.text("Team") ]), Halogen_HTML_Elements.th_([ Halogen_HTML_Core.text("Score") ]) ]) ])(rows)) ]);
      };
...
(function($PS) {
  ...
  var Halogen_Query_HalogenM = $PS["Halogen.Query.HalogenM"];
  var Nav = $PS["Nav"];
  var QuestionUI = $PS["QuestionUI"];
  var Samples = $PS["Samples"];
  var Scoreboard = $PS["Scoreboard"];                
  var NavEvent = (function () {
      function NavEvent(value0) {
          this.value0 = value0;
      };
      NavEvent.create = function (value0) {
          return new NavEvent(value0);
      };
      return NavEvent;
  })();
  var ResponseEvent = (function () {
      function ResponseEvent(value0) {
          this.value0 = value0;
      };
      ResponseEvent.create = function (value0) {
  ...
  var setStatus = function (page) {
      return function (newStatus) {
          return function (questions) {
              return Data_Array.modifyAt(page)(function (oldQuestion) {
                  return {
                      status: newStatus,
                      response: oldQuestion.response,
                      sample: oldQuestion.sample
                  };
              })(questions);
          };
  ...
  var moveNextPage = function (questions) {
      return function (page) {
          return Control_Bind.bind(Data_Maybe.bindMaybe)(Data_Array.index(questions)(page))(function (initialQuestion) {
              return new Data_Maybe.Just((Data_FoldableWithIndex.foldlWithIndex(Data_FoldableWithIndex.foldableWithIndexArray)(function (i) {
  ...
  var langs = Data_Array.sort(Data_Ord.ordString)(Data_Functor.map(Data_Functor.functorArray)(function (s) {
      return s.language;
  })(Samples.samples));
  var initialResponse = {
      algorithm: "Burrito",
  ...
  var initialQuestions = Data_Functor.map(Data_Functor.functorArray)(function (sample) {
      return {
          sample: sample,
          status: Common.Unsubmitted.value,
  ...
  var component = function (dictMonadAff) {
      var render = function (v) {
          ...
          var qui = Data_Maybe.fromMaybe(Halogen_HTML_Core.text("Error."))(Control_Bind.bind(Data_Maybe.bindMaybe)(Data_Array.index(v.questions)(v.page))(function (question) {
              return Data_Maybe.Just.create(Halogen_HTML.slot()(new Data_Symbol.IsSymbol(function () {
                  return "qui";
              }))(Data_Ord.ordInt)(Data_Symbol.SProxy.value)(0)(QuestionUI.questionComp)({
                  page: v.page,
                  question: question,
                  algos: algos,
                  langs: langs
      ...
      var handleAction = function (v) {
              ...
              return Control_Bind.bind(Halogen_Query_HalogenM.bindHalogenM)(Control_Monad_State_Class.get(Halogen_Query_HalogenM.monadStateHalogenM))(function (v1) {
                  var newState = Data_Maybe.fromMaybe({
                      ...
                      return Control_Bind.bind(Data_Maybe.bindMaybe)(moveNextPage(v1.questions)(v1.page))(function (nextPage) {
                          ...
                          return Control_Bind.bind(Data_Maybe.bindMaybe)(setStatus(v1.page)(new Common.Submitted({
                              points: points
                  ...
                  return Control_Bind.bind(Halogen_Query_HalogenM.bindHalogenM)(Effect_Aff_Class.liftAff(Halogen_Query_HalogenM.monadAffHalogenM(dictMonadAff))(Affjax.post(Affjax_ResponseFormat.json)("/score")(Data_Maybe.Just.create(Affjax_RequestBody.json(Data_Argonaut_Encode_Class.encodeJson(Data_Argonaut_Encode_Class.encodeRecord(Data_Argonaut_Encode_Class.gEncodeJsonCons(Data_Argonaut_Encode_Class.encodeJsonInt)(Data_Argonaut_Encode_Class.gEncodeJsonCons(Data_Argonaut_Encode_Class.encodeRecord(Data_Argonaut_Encode_Class.gEncodeJsonCons(Data_Argonaut_Encode_Class.encodeJsonInt)(Data_Argonaut_Encode_Class.gEncodeJsonCons(Data_Argonaut_Encode_Class.encodeJsonJString)(Data_Argonaut_Encode_Class.gEncodeJsonNil)(new Data_Symbol.IsSymbol(function () {
                      ...
                      if (resp instanceof Data_Either.Right) {
                          ...
                          throw new Error("Failed pattern match at Quiz (line 104, column 9 - line 106, column 93): " + [ v2.constructor.name ]);
                      };
                      throw new Error("Failed pattern match at Quiz (line 101, column 5 - line 106, column 93): " + [ resp.constructor.name ]);
                  });
              });
          };
          if (v instanceof ResponseEvent && v.value0 instanceof QuestionUI.SetResponse) {
              return Control_Bind.bind(Halogen_Query_HalogenM.bindHalogenM)(Control_Monad_State_Class.get(Halogen_Query_HalogenM.monadStateHalogenM))(function (state) {
                  ...
                  throw new Error("Failed pattern match at Quiz (line 112, column 5 - line 114, column 27): " + [ newQuestions.constructor.name ]);
              });
          };
          if (v instanceof Receive) {
              return Control_Monad_State_Class.modify_(Halogen_Query_HalogenM.monadStateHalogenM)(function (state) {
          ...
          throw new Error("Failed pattern match at Quiz (line 88, column 3 - line 88, column 98): " + [ v.constructor.name ]);
      };
      return Halogen_Component.mkComponent({
          initialState: initialState,
          render: render,
...
(function($PS) {
  ...
  var SetName = (function () {
      function SetName(value0) {
          this.value0 = value0;
      };
      SetName.create = function (value0) {
          return new SetName(value0);
      };
      return SetName;
  })();
  var Join = (function () {
  ...
  var component = function (dictMonadAff) {
      ...
      var render = function (v) {
          ...
          var quiz = Halogen_HTML.slot()(new Data_Symbol.IsSymbol(function () {
              return "quiz";
          }))(Data_Ord.ordInt)(Data_Symbol.SProxy.value)(0)(Quiz.component(dictMonadAff))({
              team: v.team,
              scores: v.scores
          })(Data_Void.absurd);
          return quiz;
      ...
      var handleAction = function (v) {
          if (v instanceof SetName) {
              return Control_Monad_State_Class.modify_(Halogen_Query_HalogenM.monadStateHalogenM)(function (state) {
                  ...
                  $18.team = (function () {
                      var $15 = {};
                      for (var $16 in state.team) {
                          if ({}.hasOwnProperty.call(state.team, $16)) {
                              $15[$16] = state["team"][$16];
                          };
                      };
                      $15.name = v.value0;
          ...
          if (v instanceof Join) {
              return Control_Bind.bind(Halogen_Query_HalogenM.bindHalogenM)(Control_Monad_State_Class.get(Halogen_Query_HalogenM.monadStateHalogenM))(function (state) {
                  var $22 = state.team.name !== "";
                  if ($22) {
                      return Control_Bind.bind(Halogen_Query_HalogenM.bindHalogenM)(Effect_Class.liftEffect(Halogen_Query_HalogenM.monadEffectHalogenM(dictMonadAff.MonadEffect0()))(Effect_Random.randomInt(0)(100000000)))(function (key) {
                          return Control_Bind.discard(Control_Bind.discardUnit)(Halogen_Query_HalogenM.bindHalogenM)(Control_Monad_State_Class.put(Halogen_Query_HalogenM.monadStateHalogenM)((function () {
                              ...
                              $26.team = (function () {
                                  var $23 = {};
                                  for (var $24 in state.team) {
                                      if ({}.hasOwnProperty.call(state.team, $24)) {
                                          $23[$24] = state["team"][$24];
                                      };
                                  };
                                  $23.key = key;
                  ...
                  return Control_Bind.bind(Halogen_Query_HalogenM.bindHalogenM)(Effect_Aff_Class.liftAff(Halogen_Query_HalogenM.monadAffHalogenM(dictMonadAff))(Affjax.get(Affjax_ResponseFormat.json)("/score")))(function (result) {
                      ...
                      if (result instanceof Data_Either.Right) {
                          ...
                          if (decoded instanceof Data_Either.Left) {
                              return Effect_Class.liftEffect(Halogen_Query_HalogenM.monadEffectHalogenM(dictMonadAff.MonadEffect0()))(Effect_Console.logShow(Data_Argonaut_Decode_Error.showJsonDecodeError)(decoded.value0));
                          };
                              ...
                              return Control_Bind.discard(Control_Bind.discardUnit)(Halogen_Query_HalogenM.bindHalogenM)(Effect_Class.liftEffect(Halogen_Query_HalogenM.monadEffectHalogenM(dictMonadAff.MonadEffect0()))(Effect_Console.log("decoded response")))(function () {
                                  return Control_Bind.discard(Control_Bind.discardUnit)(Halogen_Query_HalogenM.bindHalogenM)(Effect_Class.liftEffect(Halogen_Query_HalogenM.monadEffectHalogenM(dictMonadAff.MonadEffect0()))(Effect_Console.logShow(Data_List_Types.showList(Data_Show.showRecord()(Data_Show.showRecordFieldsCons(new Data_Symbol.IsSymbol(function () {
                                      ...
                                      return Control_Monad_State_Class.modify_(Halogen_Query_HalogenM.monadStateHalogenM)(function (state) {
                                          ...
                                          $33.scores = Data_Map_Internal.values(decoded.value0);
                                          return $33;
                                      });
                                  });
                              });
                          };
                          throw new Error("Failed pattern match at Main (line 95, column 9 - line 101, column 71): " + [ decoded.constructor.name ]);
                      };
                      throw new Error("Failed pattern match at Main (line 91, column 5 - line 101, column 71): " + [ result.constructor.name ]);
                  });
              });
          };
          throw new Error("Failed pattern match at Main (line 77, column 3 - line 77, column 94): " + [ v.constructor.name ]);
      };
      return Halogen_Component.mkComponent({
          initialState: initialState,
          render: render,
